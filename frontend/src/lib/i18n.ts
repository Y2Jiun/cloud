...
const resources = {
	en: {
		translation: {
			...
			"nav.scam-reports": "Scam Reports",
			"nav.scam-alerts": "Scam Alerts",
			"nav.legal-cases": "Legal Cases",
			"nav.help": "Help & FAQ",
	...
	es: {
		translation: {
			...
			"nav.scam-reports": "Reportes de Estafa",
			"nav.scam-alerts": "Alertas de Estafa",
			"nav.legal-cases": "Casos Legales",
	...
	fr: {
		translation: {
			...
			"nav.scam-reports": "Rapports d'Escroquerie",
			"nav.scam-alerts": "Alertes d'Escroquerie",
			"nav.legal-cases": "Affaires Juridiques",
	...
	de: {
		translation: {
			...
			"nav.scam-reports": "Betrugsberichte",
			"nav.scam-alerts": "Betrugswarnungen",
			"nav.legal-cases": "Rechtsfälle",
	...
	zh: {
		translation: {
			...
			"nav.customers": "客户",
			"nav.integrations": "集成",
			"nav.scam-reports": "诈骗举报",
			"nav.scam-alerts": "诈骗警报",
			"nav.legal-cases": "法律案件",
			"nav.settings": "设置",
			"nav.account": "账户",
			"nav.error": "错误",
	...
	ja: {
		translation: {
			...
			"nav.customers": "顧客",
			"nav.integrations": "統合",
			"nav.scam-reports": "詐欺報告",
			"nav.scam-alerts": "詐欺警告",
			"nav.legal-cases": "法的事件",
			"nav.settings": "設定",
			"nav.account": "アカウント",
			"nav.error": "エラー",
